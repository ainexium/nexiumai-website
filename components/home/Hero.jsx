        ...
        <div className="hero-main-grid" style={{ display: "grid", gridTemplateColumns: "3fr 1fr" }}>
          ...
          >
            <p style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 28, color: "var(--accent)" }}>
              L'intelligence, au service du possible
            </p>
            <h1 style={{ fontSize: "clamp(2.2rem, 5.5vw, 3.6rem)", fontWeight: 700, lineHeight: 1.08, letterSpacing: "-0.03em", color: "var(--fg)", maxWidth: 580, marginBottom: 20 }}>
              Nous construisons le logiciel de demain.
            </h1>
            <p style={{ fontSize: 15, maxWidth: 440, lineHeight: 1.65, color: "var(--fg-2)" }}>
              NEXIUM.AI conçoit des produits SaaS et des solutions technologiques pour aider les entreprises à franchir le cap du numérique.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              Voir nos produits <span>›</span>
            </a>
            <a
              href="mailto:ai.nexium@gmail.com"
              className="btn-slide-fill-outline"
              style={{
                display: "flex", alignItems: "center", justifyContent: "space-between",
                padding: "13px 18px", borderRadius: 6,
                fontSize: 13, fontWeight: 500,
                textDecoration: "none", position: "relative", zIndex: 0,
              }}
            >
              <span style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>Nous contacter <span>›</span></span>
            </a>
          </motion.div>
        </div>
