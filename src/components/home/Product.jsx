...
// Mettre à false pour masquer les produits à venir
  ...
  return (
    <section id="produit" ref={ref} style={{ position: "relative", background: "var(--bg-section)" }}>
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", position: "relative", zIndex: 1, background: "var(--bg-section)", borderLeft: "1px solid var(--border)", borderRight: "1px solid var(--border)" }}>
        ...
        {/* Main card — two-column bordered layout */}
        <motion.div
        ...
        >
          ...
          <div className="product-left" style={{ padding: "48px", borderRight: "1px solid var(--border)" }}>
            ...
            <h3 style={{ fontSize: 20, fontWeight: 700, color: "var(--fg)", margin: "0 0 10px", letterSpacing: "-0.02em" }}>NEXIUM Storage</h3>
            <p style={{ fontSize: 13, color: "var(--fg-2)", lineHeight: 1.7, marginBottom: 28 }}>
              Plateforme cloud de stockage objet S3-compatible. Conçue pour les développeurs qui veulent une solution simple, rapide à intégrer et sans friction.
            </p>
        ...
        >
          <span style={{ fontSize: 12, color: "var(--fg-3)" }}>SDKs :</span>
          {[
        ...
        {/* Cards produits à venir — désactiver via SHOW_UPCOMING = false */}
        {SHOW_UPCOMING && (
          <motion.div
            ...
            {upcoming.map((p, i) => (
              ...
              >
                <span style={{
                  ...
                  textTransform: "uppercase", padding: "3px 10px", borderRadius: 99, marginBottom: 20,
                  background: "var(--tag-bg)", color: "var(--tag-fg)", border: "1px solid var(--tag-border)",
                }}>
                  {p.tag}
                </span>
                <h3 style={{ fontSize: 18, fontWeight: 700, color: "var(--fg)", margin: "0 0 10px", letterSpacing: "-0.02em" }}>{p.name}</h3>
                <p style={{ fontSize: 13, color: "var(--fg-2)", lineHeight: 1.7, marginBottom: 24 }}>{p.desc}</p>
